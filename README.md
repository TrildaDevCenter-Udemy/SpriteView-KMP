<p align="center">
  <a href="https://central.sonatype.com/artifact/com.stevdza-san/sprite"><img alt="Profile" src="https://badgen.net/badge/Maven Central/v1.1.0/blue?icon=github"/></a>
</p>
...
### Sprite Flip
You can also make use of the `spriteFlip` parameter to change the orientation of the `SpriteSheet` iself. A default parameter is `null`, and there are three options: `Vertical`, `Horizontal`, `Both`.

<p align="center">
<img src="images/1.png?raw=true" width="150"/>
<img src="images/2.png?raw=true" width="150"/>
<img src="images/3.png?raw=true" width="150"/>
<img src="images/4.png?raw=true" width="150"/>
</p>
